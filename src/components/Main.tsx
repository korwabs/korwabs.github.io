...
const Main = () => {
  const contactAction = () => {
    window.location.href = "mailto:wabs@wabs.io";
  };
          ...
          <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div className="flex flex-col w-full md:w-3/5 justify-center items-start text-center md:text-left">
              ...
              <h1 className="my-4 text-5xl font-bold leading-tight">
                Monitoring & LCA Management
              </h1>
              <p className="leading-normal text-2xl mb-8">
                저희는 에너지 모니터링 및 생애주기 평가(Life Cycle Assessment,
                LCA) 관리를 위한 첨단 솔루션을 개발하는 전문 기업입니다.
              </p>
            ...
            <div className="flex flex-wrap">
              <div className="w-5/6 sm:w-1/2 p-6">
                ...
                <p className="text-gray-600 mb-8">
                  HTML5 기반 반응형 웹 제공을 통하여, PC 및 모바일 환경에서
                  사용하기 편한 환경을 제공합니다.
                </p>
              </div>
            ...
            <div className="flex flex-wrap flex-col-reverse sm:flex-row">
              ...
              <div className="w-full sm:w-1/2 p-6 mt-6">
                <div className="align-middle">
                  ...
                  <p className="text-gray-600 mb-8">
                    ISO 14040, ISO 14044 국제표준을 준수하는 LCA 관리 솔루션을
                    개발합니다.
                  </p>
                </div>
              </div>
              ...
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <div className="w-full font-bold text-xl text-gray-800 px-6">
                    Spring Boot 기반 백앤드 개발
                  </div>
                  <p className="text-gray-800 text-base px-6 mb-5">
                    Spring Boot 기반 백앤드 개발 기술을 보유중이며, 전자정부
                    프레임워크에 맞추어 개발 할 수 있습니다.
                  </p>
                </a>
              </div>
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    시계열 데이터베이스(TSDB)를 사용하여 실시간 IoT 데이터를
                    수집 및 모니터링 할 수 있습니다.
                  </p>
                </a>
              </div>
            ...
            <div className="w-full md:w-1/3 p-6 flex flex-col flex-grow flex-shrink">
              <div className="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow">
                ...
                >
                  ...
                  <p className="text-gray-800 text-base px-6 mb-5">
                    수집된 시계열 데이터를 AI 기반으로 오류진단을 할 수
                    있습니다.
                  </p>
                </a>
              </div>
          ...
          <div className="container mx-auto px-2 pt-4 pb-12 text-gray-800">
            ...
            <div className="flex flex-col sm:flex-row justify-center pt-12 my-12 sm:my-4">
              ...
              <div className="flex-1 bg-white text-gray-600 rounded-t rounded-b-none overflow-hidden shadow">
                ...
                <div className="p-4">
                  <img src="product_monitoring.png" />
                </div>
              </div>
              <div className="flex-none mt-auto bg-white rounded-b rounded-t-none overflow-hidden shadow p-6">
                <div className="flex items-center justify-center">
